...
public class Steps
{
	...
	public void loginRambler(String username, String password) throws InterruptedException {
	...
	public void newsRambler() {
		LoginPage loginPage = new LoginPage(driver);
		loginPage.openPage();
		loginPage.news();

	}
	public void gamesRambler() {
		LoginPage loginPage = new LoginPage(driver);
		loginPage.openPage();
		loginPage.games();

	}
	public void horoscopesRambler() {
		LoginPage loginPage = new LoginPage(driver);
		loginPage.openPage();
		loginPage.horoscopes();

	}
	public void datingRambler() {
		LoginPage loginPage = new LoginPage(driver);
		loginPage.openPage();
		loginPage.dating();
